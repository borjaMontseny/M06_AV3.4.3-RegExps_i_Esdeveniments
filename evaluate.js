...
window.onload = function () {
  ...
  var regeExpTelefon = /^(?:[9876]\d{8}|[9876]\d{2} \d{3} \d{3}|[9876]\d{1} \d{3} \d{2} \d{2})$/;  // 977751487, 977 751 487, 97 712 34 56
  var regeExpTelefon2 = /^(\+\d{3} ?)?(?:[9876]\d{8}|[9876]\d{2} \d{3} \d{3}|[9876]\d{1} \d{3} \d{2} \d{2})$/;
